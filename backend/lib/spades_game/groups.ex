defmodule SpadesGame.Groups do
  ...
  def new() do
    %Groups{
      ...
      gPlayer1Play1:            Group.new("gPlayer1Play1","Play","play","cPlayer1"),
      gPlayer1Play2:            Group.new("gPlayer1Play2","Play","play","cPlayer1"),
      ...
      gPlayer2Play1:            Group.new("gPlayer2Play1","Play","play","cPlayer2"),
      gPlayer2Play2:            Group.new("gPlayer2Play2","Play","play","cPlayer2"),
      ...
      gPlayer3Play1:            Group.new("gPlayer3Play1","Play","play","cPlayer3"),
      gPlayer3Play2:            Group.new("gPlayer3Play2","Play","play","cPlayer3"),
      ...
      gPlayer4Play1:            Group.new("gPlayer4Play1","Play","play","cPlayer4"),
      gPlayer4Play2:            Group.new("gPlayer4Play2","Play","play","cPlayer4"),
