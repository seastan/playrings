defmodule SpadesGame.GameUI do
  ...
  """
  @spec move_card(GameUI.t(), number | :bot, HTMLElement) :: GameUI.t()
  def move_card(game_ui, user_id, drag_data) do
    IO.puts("game_ui: move_card a")
    case Game.move_card(game_ui.game, user_id, drag_data) do
      {:ok, new_game} ->
        %{game_ui | game: new_game}
        |> checks
