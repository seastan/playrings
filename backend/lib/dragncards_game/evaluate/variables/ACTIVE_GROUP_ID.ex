defmodule DragnCardsGame.Evaluate.Variables.ACTIVE_GROUP_ID do
  ...
  @moduledoc """
  Returns the id of the active group. The active group is set when a player clicks on a group's dropdown menu. If the user has not clicked on a group's dropown menu, then the the active group is the one containing the card currently being hovered over.
